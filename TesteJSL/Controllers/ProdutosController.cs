...
namespace TesteJSL.Controllers
{
    public class ProdutosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,ValorProduto,Ativo")] Produto produto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,ValorProduto,Ativo")] Produto produto)
        {
            if (id != produto.Id)
            {
                return NotFound();
